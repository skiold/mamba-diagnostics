...
ADMINS = (
    ('Aptivate infra-diagnostics team', 'infra-diagnostics-team@aptivate.org'),
    ('Adrian Silva', 'adrians@aptivate.org'),  # this is in case the above email doesn't work
)
...
DEFAULT_FROM_EMAIL = 'donotreply@aptivate.org'
SERVER_EMAIL = 'server@aptivate.org'
########## MANAGER/EMAIL CONFIGURATION
...
if DEBUG is False:
    ...
    ALLOWED_HOSTS = [
        '.aptivate.org',
        'www.aptivate.org',
        'fen-vz-infra-diagnostics-stage.fen.aptivate.org',
        'fen-vz-infra-diagnostics-dev.fen.aptivate.org',
        'infra-diagnostics.dev.aptivate.org',
        'infra-diagnostics.stage.aptivate.org',
    ]
